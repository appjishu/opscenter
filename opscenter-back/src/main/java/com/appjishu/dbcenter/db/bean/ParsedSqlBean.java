...
public class ParsedSqlBean {
	...
	private Map<String,Boolean> outParam;


	/**
	 * Create a new instance of the {@link ParsedSqlBean} class.
	 * @param originalSql the SQL statement that is being (or is to be) parsed
	 */
	public ParsedSqlBean(String originalSql) {
	...
	public Map<String, Boolean> getOutParam() {
		return outParam;
	}

	public void setOutParam(String[] outParam) {
		this.outParam = new HashMap<String, Boolean>();
		if(null == outParam) return;
		for (String string : outParam) this.outParam.put(string, true);
	}
